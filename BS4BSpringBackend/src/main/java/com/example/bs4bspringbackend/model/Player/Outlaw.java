...
public class Outlaw extends AbstractPlayer{
    ...
    private static final int BANDIT_HEALTH = 150;
    private static final int BANDIT_SPEED = 4;
    private static final String BANDIT_FRONTEND_ID = "3";

    public Outlaw(String id, WebSocketSession session, String name, Vector2 position, int rotationAngle, Collider collider, Weapon weapon) {
